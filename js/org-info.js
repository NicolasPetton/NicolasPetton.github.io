 ...
 *
 * Modified by Nicolas Petton petton.nicolas at gmail dot com
 *
 * This software is subject to the GNU General Public Licens version 3:
 * see: /web/20130128130817/http://www.gnu.org/licenses/
 *
 * Requirements:
 *
 *   Org-mode >= 6.12a
 ...
 *  org_html_manager.set("LINK_UP", "/web/20130128130817/http://full/path/to/index/of/this/directory.html");
 *  org_html_manager.set("LINK_HOME", "/web/20130128130817/http://full/path/to/homepage.html");
...
var org_html_manager = {
  ...
  setup: function ()
  {
    ...
    //Nico's modif
    '<a href="javascript:org_html_manager.showHelp();">Keyboard shortcuts <code>?</code></a> / ' +
    '<a href="javascript:org_html_manager.navigateTo(\'?/toc/?\');">List of posts <code>i</code></a>';
